...
export default function BookingStep2() {
  const [isInspectorOn, setIsInspectorOn] = useState<boolean>(false);
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-[#0A1A17] rounded-[32px] overflow-hidden border border-white/5 shadow-xl">
              ...
              <div className="p-6">
                ...
                <h3 className="text-2xl font-bold">{formData.carModel}</h3>
            ...
            <div className="bg-[#1A302A]/30 rounded-[32px] p-6 border border-[#285A48]/30">
              <div className="flex gap-4">
                <div className="bg-[#1A302A] p-3 rounded-2xl h-fit border border-[#285A48] text-xl">📍</div>
          ...
          <div className="lg:col-span-7 bg-[#0A1A17] rounded-[40px] p-10 border border-white/5 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select 
                      ...
                      className="w-full bg-[#020D0B] border border-[#285A48] rounded-2xl py-4 pl-14 pr-6 text-sm font-bold focus:border-[#408A71] outline-none transition-all appearance-none"
                      required
                    >
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-gray-500 leading-tight mt-1 max-w-xs">
                      ส่งช่าง AutoCheck ไปตรวจรถที่เต็นท์ก่อนคุณไปถึง 150+ จุด
                    </p>
                  </div>
                </div>
                <div 
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className={`w-full ${isLoading ? 'bg-gray-500 cursor-not-allowed' : 'bg-white hover:bg-[#B0E4CC]'} text-[#020D0B] font-black py-5 rounded-[24px] shadow-xl transition-all active:scale-[0.98] mt-4 uppercase tracking-widest flex items-center justify-center gap-3`}
              >
                {isLoading ? 'Processing...' : <><span className="text-xl">✓</span> CONFIRM BOOKING</>}
              </button>
            </form>
          </div>
        </div>
